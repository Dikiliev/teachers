...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('main', '0018_remove_studentgroup_price'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_phone', models.CharField(blank=True, max_length=25, verbose_name='Номер телефона')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Дата создания')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Дата обновления')),
                ('subject', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='applications', to='main.subject', verbose_name='Предмет')),
